  ...
  return (
    <Element className="experienceContainer" id="exp">
      ...
      <div className='experienceContainer__info'>
        ...
        <Experience number="2015-2019" title='I am pursuing my UG studies with major in IT(Information Technology) and scored 72%,I have also been part of Cultural Team(Student Co-ordinator) since my first year of college.'></Experience>
      </div>
    </Element>
  )
}
